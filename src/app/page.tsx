...
import { getHomePageFeaturedBanner } from '@/lib/services/featuredBannerService';
...
async function loadFeaturedBanner(): Promise<FeaturedBanner | null> {
  console.log('[HomePage] Attempting to fetch featured banner...');
  try {
    const banner = await getHomePageFeaturedBanner();
...
export default async function HomePage() {
  ...
  const featuredBanner = await loadFeaturedBanner();
